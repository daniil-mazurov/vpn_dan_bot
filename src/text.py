...
BOT_STEPS = [
    ...
    """5. <b>Скачайте приложение</b>: 
    
    - Убедитесь, что у вас установлено приложение, поддерживающее WireGuard.\n\nДля пользователей android смартфонов рекомендуется использовать приложение Amnezia VPN (https://play.google.com/store/apps/details?id=org.amnezia.vpn).\n\nВ противном случае вы можете скачать его на официальном сайте WireGuard (https://www.wireguard.com/install/), приложение работает на Windows, macOS, Linux, Android и iOS.""",
...
WG_STEPS = {
    ...
    - Рекомендуется использовать приложение Amnezia VPN (https://play.google.com/store/apps/details?id=org.amnezia.vpn).
    - В случае некорректной работы оригинального приложения воспользуйтесь альтернативными клиентами: 
        'WG Tunnel':
    ...
    - Если вы скачали приложение <b>Amnezia VPN</b>, то получите файл конфигурации у бота и, кликнув на файл, выберите приложение <b>Amnezia VPN</b> (не забудьте поставить галочку обфускации в приложении)
    - В противном случае откройте приложение и нажмите на кнопку "Добавить туннель" (или значок ✚ в правом нижнем углу).
    ...
    - После импорта конфигурации вы увидите ваш туннель в списке. Нажмите на переключатель рядом с названием туннеля, чтобы активировать VPN-соединение. (или кнопка Connect)""",
        """5. <b>Проверьте подключение</b>:
